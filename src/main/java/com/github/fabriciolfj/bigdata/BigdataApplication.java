...
public class BigdataApplication {
	...
	@Value("classpath:user.schema")
	private Resource schemaFilePath;

	private String outputDirectoryPath;

	private static final Logger logger = LoggerFactory.getLogger(BigdataApplication.class);
	...
	public CommandLineRunner commandLineRunner() {
		return args -> {
			outputDirectoryPath = getClass().getClassLoader().getResource("/output").getPath();
	...
	private MessageType getSchemaForParquetFile() throws IOException {
		File resource = schemaFilePath.getFile();
